...
/******************************************************************************
  ...
  To compile adapt the code below wo match your filenames:  
    cc -o ip_coursework_002_mthread ip_coursework_002_mthread.c -lglut -lGL -lm -pthread
...
void detect_edges(unsigned char *in, unsigned char *out, s_thread *args) {
  int i;
